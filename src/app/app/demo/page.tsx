...
const steps = [
  ...
  { n: 6, icon: Bot, title: 'Copiloto — asistencia controlada', desc: 'El copiloto sugiere pasos, mensajes y respuestas a objeciones en modo determinístico interno. El sistema valida el flujo comercial antes de activar cualquier motor.', href: '/app/copiloto', cta: 'Ver Copiloto', value: 'Asistencia como apoyo del asesor, no como reemplazo' },
